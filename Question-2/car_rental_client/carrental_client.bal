...
public function main() returns error? {
    AddCarRequest addCarRequest = {car: {plate: "ballerina", make: "ballerina", model: "ballerina", year: 1, daily_price: 1, mileage: 1, status: "CAR_STATUS_UNSPECIFIED", color: "ballerina", description: "ballerina"}};
    AddCarResponse addCarResponse = check ep->AddCar(addCarRequest);
    io:println(addCarResponse);

    UpdateCarRequest updateCarRequest = {plate: "ballerina", updated: {plate: "ballerina", make: "ballerina", model: "ballerina", year: 1, daily_price: 1, mileage: 1, status: "CAR_STATUS_UNSPECIFIED", color: "ballerina", description: "ballerina"}};
    ...
    ListAvailableCarsRequest listAvailableCarsRequest = {filter_text: "ballerina", year: 1};
    ...
    ListReservationsRequest listReservationsRequest = {user_id: "ballerina"};
    ...
    User createUsersRequest = {id: "ballerina", name: "ballerina", email: "ballerina", role: "USER_ROLE_UNSPECIFIED"};
